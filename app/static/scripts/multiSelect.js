...
// fetch the get_tags api using async await
    ...
    document.querySelectorAll("select[multiple]").forEach((el, k) => {
      ...
      var search = newEl("input", {
        ...
        style: {
          width: "100%",
          display:
            el.attributes["multiselect_search"]?.value === "true"
              ? "block"
              : "none",
        },
      ...
      el.loadOptions = () => {
        ...
        if (el.attributes["multiselect_select_all"]?.value == "true") {
        ...
        div.refresh = () => {
          ...
          if (
            sels.length > (el.attributes["multiselect_max_items"]?.value ?? 5)
          ) {
            div.appendChild(
              newEl("span", {
            ...
            sels.map((x) => {
              ...
              if (tagNameColorPair[x.text]) {
                c.style.backgroundColor = tagNameColorPair[x.text];
              }
